...
public class LocalizationTest extends OpMode {
    ...
    public void init() {
        ...
        frontLeft = hardwareMap.get(DcMotorEx.class, leftFrontMotorName);
        rearLeft = hardwareMap.get(DcMotorEx.class, leftRearMotorName);
        rearRight = hardwareMap.get(DcMotorEx.class, rightRearMotorName);
        frontRight = hardwareMap.get(DcMotorEx.class, rightFrontMotorName);
        frontLeft.setDirection(leftFrontMotorDirection);
        rearLeft.setDirection(leftRearMotorDirection);
        frontRight.setDirection(rightFrontMotorDirection);
        rearRight.setDirection(rightRearMotorDirection);

        motors = Arrays.asList(frontLeft, rearLeft, frontRight, rearRight);
