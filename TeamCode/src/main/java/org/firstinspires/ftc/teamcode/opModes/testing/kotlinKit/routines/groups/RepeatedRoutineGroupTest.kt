...
import org.firstinspires.ftc.teamcode.kotlinKit.routines.groups.RepeatedRoutineGroup

//@Disabled
//@Deprecated("TESTED AND WORKING")
@TeleOp(name = "Test Routine Groups: Repeated", group = "[T] Testing KotlinKit Routines")
class RepeatedRoutineGroupTest : OpMode(
    enableRoutineLogTelemetry = true
) {

    class TestRoutine : Wait(1000.0, hiddenInLogs = false)
    class TestRoutineGroup : RepeatedRoutineGroup(
        TestRoutine(),
        count = 5
    )
